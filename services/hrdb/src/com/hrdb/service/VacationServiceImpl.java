...
public class VacationServiceImpl implements VacationService {
    ...
    private WMGenericDao<Vacation, BigDecimal> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Vacation, BigDecimal> wmGenericDao){
    ...
    @Override
    public Vacation delete(BigDecimal vacationId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Vacation findById(BigDecimal id) throws EntityNotFoundException {
