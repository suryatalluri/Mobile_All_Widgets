...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    private WMGenericDao<Department, BigDecimal> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Department, BigDecimal> wmGenericDao){
    ...
    @Override
    public Department delete(BigDecimal departmentId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Department findById(BigDecimal id) throws EntityNotFoundException {
    ...
    public Department update(Department updated) throws EntityNotFoundException {
        ...
        BigDecimal id = (BigDecimal)updated.getDeptid();
