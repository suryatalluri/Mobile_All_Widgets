...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    private WMGenericDao<Employee, BigDecimal> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Employee, BigDecimal> wmGenericDao){
    ...
    @Override
    public Employee delete(BigDecimal employeeId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Employee findById(BigDecimal id) throws EntityNotFoundException {
    ...
    public Employee update(Employee updated) throws EntityNotFoundException {
        ...
        BigDecimal id = (BigDecimal)updated.getEid();
