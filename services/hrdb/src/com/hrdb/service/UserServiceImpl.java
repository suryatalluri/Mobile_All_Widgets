...
public class UserServiceImpl implements UserService {
    ...
    private WMGenericDao<User, BigDecimal> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<User, BigDecimal> wmGenericDao){
    ...
    @Override
    public User delete(BigDecimal userId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public User findById(BigDecimal id) throws EntityNotFoundException {
    ...
    public User update(User updated) throws EntityNotFoundException {
        ...
        BigDecimal id = (BigDecimal)updated.getUserid();
