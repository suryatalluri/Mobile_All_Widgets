...
public class DepartmentController {
    ...
    public Department getDepartment(@PathVariable("id") BigDecimal id) throws EntityNotFoundException {
    ...
    public boolean deleteDepartment(@PathVariable("id") BigDecimal id) throws EntityNotFoundException {
    ...
    public Department editDepartment(@PathVariable("id") BigDecimal id, @RequestBody Department instance) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the employees instance associated with the given id.")
     public Page<Employee> findAssociatedemployees(Pageable pageable, @PathVariable("id") BigDecimal id){
