...
public class EmployeeController {
    ...
    public Employee getEmployee(@PathVariable("id") BigDecimal id) throws EntityNotFoundException {
    ...
    public boolean deleteEmployee(@PathVariable("id") BigDecimal id) throws EntityNotFoundException {
    ...
    public Employee editEmployee(@PathVariable("id") BigDecimal id, @RequestBody Employee instance) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the vacations instance associated with the given id.")
     public Page<Vacation> findAssociatedvacations(Pageable pageable, @PathVariable("id") BigDecimal id){
    ...
    @ApiOperation(value = "Gets the employeesForManagerid instance associated with the given id.")
     public Page<Employee> findAssociatedemployeesForManagerid(Pageable pageable, @PathVariable("id") BigDecimal id){
