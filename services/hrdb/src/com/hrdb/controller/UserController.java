...
public class UserController {
    ...
    public User getUser(@PathVariable("id") BigDecimal id) throws EntityNotFoundException {
    ...
    public boolean deleteUser(@PathVariable("id") BigDecimal id) throws EntityNotFoundException {
    ...
    public User editUser(@PathVariable("id") BigDecimal id, @RequestBody User instance) throws EntityNotFoundException {
